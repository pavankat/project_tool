...
<b>Error:</b>  <tt>Can't mass-assign protected attributes: name, email, password
...
<b>Error:</b>  <tt>uninitialized constant User::SHA1

app/models/user.rb:9:in `password='

app/controllers/users_controller.rb:43:in `new'

app/controllers/users_controller.rb:43:in `create'</tt>
